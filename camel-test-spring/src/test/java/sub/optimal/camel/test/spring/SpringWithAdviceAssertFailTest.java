...
public class SpringWithAdviceAssertFailTest extends CamelSpringTestSupport {

    @Override
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring/all-routes-assertfail.xml");
    }
